...
const Footer = () => {
    return (
        <>
            <footer className="px-4 mt-80 md:mt-8 divide-y bg-gray-200 dark:bg-gray-800 dark:text-gray-100">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            ...
                            <span className="self-center text-2xl font-semibold">Kindle Teddy</span>
                        </a>
                    </div>
                ...
                <div className="py-6 text-sm text-center dark:text-gray-400">© 1968 Kindle.teddy All rights reserved.</div>
            </footer>
        </>
    );
};
